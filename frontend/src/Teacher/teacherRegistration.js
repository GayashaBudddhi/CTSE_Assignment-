    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:8081/teacher/createTeacher', teacher )
            .then(response => {
                ...
                this.props.history.push('/teacher/complete-registration');
            })
            .catch(error => {
        ...
        return (
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}
                      className="row g-3" data-testid='form-tag-new-registration'>
                    ...
                    <div className="col-md-6">
                        ...
                        <select
                            ...
                            data-testid='gender-select-field'
                            id="gender"
                            name="gender"
                    ...
                    <div className="col-md-6">
                        ...
                        <input
                            type="text"
                            className="form-control"
                            data-testid='contact-number-field'
                            id="contactNumber"
                            name="contactNumber"
                    ...
                    <div className="col-12">
                        <button className="button-purple button2-purple" data-testid='submit-button'>Submit Your Application</button>
                    </div>
                </form>
                </div>
            </div>
